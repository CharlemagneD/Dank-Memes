...
class MemesControllerTest < ActionController::TestCase
  ...
  test "should create meme" do
    assert_difference('Meme.count') do
      post :create, meme: { bottom_text: @meme.bottom_text, meme_type: @meme.meme_type, rating: @meme.rating, top_text: @meme.top_text }
    end
  ...
  test "should update meme" do
    patch :update, id: @meme, meme: { bottom_text: @meme.bottom_text, meme_type: @meme.meme_type, rating: @meme.rating, top_text: @meme.top_text }
    assert_redirected_to meme_path(assigns(:meme))
  end
